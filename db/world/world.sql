...
--
SELECT 'CREATING city TABLE STRUCTURE' as 'INFO';
...
--
-- ORDER BY:  `ID`
SELECT 'LOADING city TABLE DATA' as 'INFO';
...
--
SELECT 'CREATING country TABLE STRUCTURE' as 'INFO';
...
--
-- ORDER BY:  `Code`
SELECT 'LOADING country TABLE DATA' as 'INFO';
...
--
SELECT 'CREATING countrylanguage TABLE STRUCTURE' as 'INFO';
...
SELECT 'LOADING countrylanguage TABLE DATA' as 'INFO';
...
SET AUTOCOMMIT=1;
SELECT 'DONE. (TABLES CREATED AND DATA LOADED)' as 'INFO';
